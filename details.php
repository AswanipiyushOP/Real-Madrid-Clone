...
$sel = "select * from piyush_modalm where id= '$id' and status=1";
...
<body>
  ...
  <div class="container py-4">
    <div class="row">
      ...
      <div class="col fw-bolder">
        <p>Match Played :<?php echo $fetch_record['matchplay'] ?> </p>
        <p>Minutes Played :<?php echo $fetch_record['minuteplay'] ?></p>
        <p>Saves: <?php echo $fetch_record['saves'] ?></p>
        <p>Goals :<?php echo $fetch_record['goalaward'] ?> </p>
        <p>Assist :<?php echo $fetch_record['assist'] ?> </p>
      </div>
    </div>
  </div>
  <!--======================Footer bottom part========================-->
