...
//Cards Data
$get_data = "select * from piyush_femalecards where status=1 limit 0,2";
$view_data = mysqli_query($conn, $get_data);

$get_data1 = "select * from piyush_femalecards where status=1 limit 2,7";
$view_data1 = mysqli_query($conn, $get_data1);

$get_data2 = "select * from piyush_femalecards where status=1 limit 9,6";
$view_data2 = mysqli_query($conn, $get_data2);

$get_data3 = "select * from piyush_femalecards where status=1 limit 15,7";
$view_data3 = mysqli_query($conn, $get_data3);

$get_data4 = "select * from piyush_femalecards where status=1 limit 22,1";
...
<body>
  ...
  <div class="container-fluid sub_header">
    <div class="row g-0">
      <div class="col-12 col-lg-6 col-md-12 col-sm-12 text-center">
        <h2 class="sub_h2">Women's Team</h2>
      </div>
  ...
  <div class="container-fluid">
    <div class="container">
      <h3 class="gk_h3 pb-2">GoalKeeper</h3>
      <div class="row">
        <?php foreach ($view_data as $show_data) { ?>
          <div class="col-12 col-lg-4 col-md-12 col-sm-12">
          <a href="womendetail.php?player_id=<?php echo $show_data['id']?>">
              ...
              <article class="card__article imges-hover">
                <div class="card__image">
                  <img src="assets/uploads/<?php echo $show_data['image']; ?>" alt="image"
                    title="<?php echo $show_data['positions']; ?>" class="card__img" />
                  <div class="card__shadow"></div>
                </div>

                <div class="card__data">
                  <h3 class="card__name"><?php echo $show_data['names']; ?><br>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <h3 class="gk_h3 pt-5 pb-2">Defend</h3>
              ...
              <article class="card__article swiper-slide imges-hover">
                ...
                <div class="card__image">
                  <img src="assets/uploads/<?php echo $show_data1['image']; ?>" alt="image"
                    title="<?php echo $show_data1['positions']; ?>" class="card__img" />
                  <div class="card__shadow"></div>
                </div>

                <div class="card__data">
                <a href="womendetail.php?player_id=<?php echo $show_data1['id']?>">
                  <button type="button" class="btn" data-bs-toggle="" data-bs-target=""
                    style="border: 0;">
                    <h3 class="card__name"><?php echo $show_data1['names']; ?><br>
                      <i class="fa fa-solid fa-hand-pointer"></i>
                    </h3>
                  </button>
                </a>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <br><br>
      <h3 style="font-weight: bolder; color: #0F2145;">Midfield</h3>
      <div class="card__container swiper ">
        <div class="card__content">
          <div class="swiper-wrapper">
              ...
              <article class="card__article swiper-slide imges-hover">
                ...
                <div class="card__image">
                  <img src="assets/uploads/<?php echo $show_data2['image']; ?>" alt="image"
                    title="<?php echo $show_data2['positions']; ?>" class="card__img" />
                  <div class="card__shadow"></div>
                </div>

                <div class="card__data">
                <a href="womendetail.php?player_id=<?php echo $show_data2['id']?>">
                  <button type="button" class="btn" data-bs-toggle="" data-bs-target=""
                    style="border: 0;">
                    <h3 class="card__name"><?php echo $show_data2['names']; ?><br>
                      <i class="fa fa-solid fa-hand-pointer"></i>
                    </h3>
                  </button>
                </a>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <br><br>
      <h3 style="font-weight: bolder; color: #0F2145;">Forward</h3>
      <div class="card__container swiper ">
        <div class="card__content">
          <div class="swiper-wrapper">
              ...
              <article class="card__article swiper-slide imges-hover">
                ...
                <div class="card__image">
                  <img src="assets/uploads/<?php echo $show_data3['image']; ?>" alt="image"
                    title="<?php echo $show_data3['positions']; ?>" class="card__img" />
                  <div class="card__shadow"></div>
                </div>

                <div class="card__data">
                <a href="womendetail.php?player_id=<?php echo $show_data3['id']?>">
                  <button type="button" class="btn" data-bs-toggle="" data-bs-target=""
                    style="border: 0;">
                    <h3 class="card__name"><?php echo $show_data3['names']; ?><br>
                      <i class="fa fa-solid fa-hand-pointer"></i>
                    </h3>
                  </button>
                </a>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <br><br>
      <h3 style="font-weight: bolder; color: #0F2145;">Coaches</h3>
      <div class="row g-0">
            ...
            <article class="card__article imges-hover">
              <div class="card__image">
                <img src="assets/uploads/<?php echo $show_data4['image']; ?>" alt="image"
                  title="<?php echo $show_data4['positions']; ?>" class="card__img" />
                <div class="card__shadow"></div>
              </div>

              <div class="card__data">
                <h3 class="card__name"><?php echo $show_data4['names']; ?><br>
                  <i class="fa fa-solid fa-hand-pointer"></i>
                </h3>
              </div>
            </article>
