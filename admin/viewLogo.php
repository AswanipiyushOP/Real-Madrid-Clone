...
$get_Data = "select * from piyush_logo where status= 1";
$logo_data = mysqli_query($conn, $get_Data);
        ...
        <div class="container">
            <div class="row mb-2">
                <div class="col-12 col-lg-12 col-md-12 col-sm-12">
                    <h2 class="pt-2 pb-2">Logo Table</h2>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex flex-row mb-3">
                                            ...
                                            <a href="history.php?edits_id=<?php echo $Data['id']; ?>">
